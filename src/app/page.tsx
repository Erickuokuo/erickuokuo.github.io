        ...
        <div className="flex justify-center items-center w-full">
          ...
          >
            <BlurFadeText
              ...
              className="font-bold tracking-tighter cursor-pointer 
             text-2xl hover:text-2.5xl 
             sm:text-3xl sm:hover:text-3.5xl 
             xl:text-4xl/none xl:hover:text-4.5xl/none hover:text-highlight
